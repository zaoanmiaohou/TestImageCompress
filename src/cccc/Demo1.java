...
public class Demo1 {
    public static void main(String[] args) {
        ...
        destPath = "C:\\Users\\cathy\\Videos\\ImageDest07.jpg";//背景色变了（黑色变蓝绿？）
...
//        destPath = "D:\\图片\\图片压缩\\test1-demo1.png";//背景色变了（黑色变蓝绿？）
    ...
    public static double compressPic(String srcFilePath, String descFilePath, float a) {
        File file = null;
        ...
        imgWriteParams.setCompressionQuality(a);

...
public class Test2 {
    public static void main(String[] args) {
        ...
        Test2.commpressPicForSize("C:\\Users\\cathy\\Desktop\\ia_100004673.jpg",
                "C:\\Users\\cathy\\Desktop\\ia_100004673.jpg", 100, 0.9); // 图片小于100kb
    ...
    public static String commpressPicForSize(String srcPath, String desPath,
        ...
        try {
            ...
            while (srcFileSizeJPG <= desFileSize * 1024){
                commpress(srcFileJPG, srcPath, desFileSize, accuracy);
            }
...
//            commpressPicCycle(desPath, desFileSize, accuracy);
    ...
    private static void commpress(File srcFileJPG, String srcPath, long desFileSize,
        ...
        Thumbnails.of(srcPath).size(desWidth, desHeight)
                .outputQuality(accuracy).toFile(srcPath);
    }
    /**
